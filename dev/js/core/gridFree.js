		...
		_core = {
			...
			createBody: function(){
				var arr     = _cache.tmpData[p.pageIndex - 1],
					tmpData = p.renderBefore(_cache.data);
				
				tmpData = tmpData ? tmpData : _cache.data;
				...
				_cache.ele.body.innerHTML = arr.length ? template(p.template, tmpData) : _cache.fragment.nullWrap;

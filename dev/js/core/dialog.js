define(['core/cncnERP', 'core/drag', 'i18n!core/nls/str'], function(cncnERP, drag, lang){
	
	/**
	* cncnERP.ui.dialog 拖拽控件
	* @class cncnERP.ui.dialog
	* @author norion.z
	...
	*/
	var dialog = {
		init: function(options){
			...
			cncnERP.ui.dialog.setZIndex(id);
			...
			if( btns ){
				...
				switch( type ){
					case 'alert':
						...
						btnMain.append('<a href="javascript:;" class="ui-btn ui-btn-primary ui-floatCenter-item l-dialog-ok"><span>'+ okText +'</span></a>');
						btnMain.find('.l-dialog-ok').click(function(){
							if( cncnERP.base.isFunction(ok) ){
								ok();
							}
							cncnERP.ui.dialog.close(id);
						});
					...
					case 'confirm':
						...
						btnMain.append('<a href="javascript:;" class="ui-btn ui-btn-primary ui-floatCenter-item l-dialog-ok"><span>'+ okText +'</span></a><a href="javascript:;" class="ui-btn ui-btnMain ui-btnMain-cancel ui-floatCenter-item l-dialog-no"><span>'+ noText +'</span></a>');
						btnMain.find('.l-dialog-ok').click(function(){
							if( cncnERP.base.isFunction(ok) ){
								ok();
							}
					...
					case 'error':
						...
						btnMain.append('<a href="javascript:;" class="ui-btn ui-btn-primary ui-btnMain-cancel ui-floatCenter-item l-dialog-no"><span>'+ noText +'</span></a>');
						btnMain.find('.l-dialog-no').click(function(){
							if( cncnERP.base.isFunction(no) ){
								no();
							}
